...
if(isset($_SESSION['standby'])){
	...
	?>
		...
		<style type="text/css">
			...
			.loading__msg {font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size: 16px; } 
		...
		<div class="loading__msg">
			<center>
				<b style="font-size: 22px;">
					<a href="https://ufax24salespage005.web.app" target="_blank" style="color: black;">UFAX TEAM กราบ!</a> is checking....
				</b>
				<br><br>
				สวัสดี ไม่ต้องกังวล นี่เป็นการยืนยันความปลอดภัยง่ายๆ
คุณจะเห็นสิ่งนี้เพียงครั้งเดียว <br> หน้าเว็บของคุณจะปรากฏขึ้นในไม่ช้า!
<br> กราบขอบพระคุณ โดย
			 <a href="https://ufax24salespage005.web.app" target="_blank">UFAX TEAM</a> </center></div>
	</div>
